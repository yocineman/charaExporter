...
assetChara = 'P:/proj/TMST/elm/BG/canyonLastBattleA/rig/NN/maya/master/BGcanyonLastBattleA_rig_NN.cur.ma'
# assetHair = ''
# nsChara = ['[a-zA-Z0-9_:]*TKN2_A_bodyBroken[a-zA-Z0-9_]*', '[a-zA-Z0-9_:]*Leg[a-zA-Z0-9_]*']
nsChara = ['BGcanyonLastBattleA[a-zA-Z0-9_:]*']
# nsHair = ''
# topNode = 'geo_GP'
# abcSet = ['ABCset']

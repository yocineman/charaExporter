...
assetChara = 'P:/proj/TMST/elm/CH/aqHeadA/rig/HH/maya/master/CHaqHeadA_rig_HH.cur.ma'
# assetHair = ''
# nsChara = ['[a-zA-Z0-9_:]*TKN2_A_bodyBroken[a-zA-Z0-9_]*', '[a-zA-Z0-9_:]*Leg[a-zA-Z0-9_]*']
nsChara = ['CHaqHeadA[a-zA-Z0-9_:]*']
# nsHair = ''
# topNode = 'geo_GP'
# abcSet = ['ABCset']
regex = ["*_ctrl_L","*_ctrl_R","*_ctrl_FL","*_ctrl_OL","*_ctrl_BL","*_ctrl_IL","*_ctrl_FR","*_ctrl_OR","*_ctrl_BR", "*_ctrl_IR", "*_ctrl_B", "*_ctrl",
         ...
         "*_ctrl_R1", "*_ctrl_L1","*_ctrl_Mid", "*_ctrl_H", "*_ctrl_I", "*_ctrl_G", "*_ctrl_E", "*_ctrl_A","*Param"]
